# Code for Spatial Econometrics: Lecture 8 "Market Access"
# Created: 11/6/19
...
xy <- rbind (c( -77.30724741044384, 38.83382348516032), # starbucks across from merten hall
             c( -77.30124991245012, 38.83144057919348)) # carow hall
...
# A different problem... Predict traffic flows in DC
