...
# but you should consider setting the data type to save storage space (e.g. INT1S for integers from -127 to 127) --- YOU MUST BE CAREFUL ABOUT THIS OR WILL LOSE DATA!!!

# Raster properties]
res(r.potato_world) # resolution
# ...is about 9km resolution at the equator
# More generally, Length of 1 degree of Longitude = cosine (latitude in decimal degrees) * length of degree (111 km or 60 naut miles) at equator
...
# Zonal operations
#Zonal statistics summarize the values of one raster layer by values (“zones”) of another raster of the same extent. For large rasters, the function only takes predefined functions in characters: “mean”, “sd”, “min”, “max”, “sum” or “count”.
...
modern_borders$mean_pot_suit <- raster::extract(r.potato, modern_borders, fun=mean, na.rm=TRUE)
